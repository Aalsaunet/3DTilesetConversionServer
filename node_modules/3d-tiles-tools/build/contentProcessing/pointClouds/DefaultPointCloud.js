...
class DefaultPointCloud {
    ...
    setPositions(positions) {
        this.addAttribute("POSITION", "VEC3", "FLOAT32", Iterables_1.Iterables.flatten(positions));
    }
    /**
     ...
     */
    setNormals(normals) {
        this.addAttribute("NORMAL", "VEC3", "FLOAT32", Iterables_1.Iterables.flatten(normals));
    }
    /**
    ...
    setNormalizedLinearColors(colors) {
        this.addAttribute("COLOR_0", "VEC4", "FLOAT32", Iterables_1.Iterables.flatten(colors));
    }
    /**
    ...
    getPositions() {
        ...
        if (!values) {
            throw new TileFormatError_1.TileFormatError("No POSITION values have been added");
        }
        return Iterables_1.Iterables.segmentize(values, 3);
    }
    ...
    getNormalizedLinearColors() {
        ...
        return Iterables_1.Iterables.segmentize(values, 4);
    }
