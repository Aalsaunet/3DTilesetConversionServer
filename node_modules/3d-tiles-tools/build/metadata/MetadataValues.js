...
class MetadataValues {
     ...
     * @returns The processed value
     */
    static processNumericEnumValue(classProperty, valueValueNames, value) {
        let stringValue;
        if (Array.isArray(value)) {
            stringValue = value.map((e) => valueValueNames[e]);
        }
        else {
        ...
        const defaultValue = classProperty.default;
        if ((0, defined_1.defined)(noData)) {
            if (ArrayValues_1.ArrayValues.deepEquals(stringValue, noData)) {
                return ArrayValues_1.ArrayValues.deepClone(defaultValue);
            }
        }
        if (!(0, defined_1.defined)(stringValue)) {
            return ArrayValues_1.ArrayValues.deepClone(defaultValue);
        }
        return stringValue;
    }
