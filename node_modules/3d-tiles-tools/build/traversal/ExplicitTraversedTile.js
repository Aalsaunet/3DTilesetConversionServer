...
class ExplicitTraversedTile {
     ...
     */
    static createRoot(root, schema, resourceResolver) {
        const traversedRoot = new ExplicitTraversedTile(root, "/root", 0, undefined, schema, resourceResolver);
     ...
     * external references (like subtree files)
     */
    constructor(tile, path, level, parent, schema, resourceResolver) {
        /**
    ...
    async getChildren() {
        ...
        const schema = this._schema;
        if (implicitTiling) {
            const children = await ExplicitTraversedTiles_1.ExplicitTraversedTiles.createTraversedChildren(implicitTiling, schema, this, this._resourceResolver);
            return children;
        }
        ...
        for (let i = 0; i < children.length; i++) {
            ...
            const traversedChild = new ExplicitTraversedTile(child, childPath, childLevel, this, this._schema, this._resourceResolver);
    ...
    getSubtreeUri() {
        ...
        const subtreeUri = ImplicitTilings_1.ImplicitTilings.substituteTemplateUri(implicitTiling.subdivisionScheme, implicitTiling.subtrees.uri, rootCoordinates);
        return subtreeUri;
    }
}
