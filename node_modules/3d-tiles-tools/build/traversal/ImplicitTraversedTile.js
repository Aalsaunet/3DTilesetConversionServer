...
class ImplicitTraversedTile {
    ...
    asRawTile() {
        ...
        Tiles_1.Tiles.setContents(tile, this.getRawContents());
        return tile;
    }
    /** {@inheritDoc TraversedTile.asFinalTile} */
    asFinalTile() {
        const tile = this.asRawTile();
        Tiles_1.Tiles.setContents(tile, this.getFinalContents());
        ...
        for (const contentAvailabilityInfo of contentAvailabilityInfos) {
            ...
            if (available) {
                ...
                if ((0, defined_1.defined)(templateUri)) {
                    ...
                    throw new ImplicitTilingError_1.ImplicitTilingError("The root of the implicit tileset did not define a template URI");
                }
            }
        }
        return contents;
