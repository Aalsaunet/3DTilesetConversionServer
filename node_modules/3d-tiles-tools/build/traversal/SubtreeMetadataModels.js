...
const MetadataUtilities_1 = require("../metadata/MetadataUtilities");
    ...
    static create(binarySubtreeData, subtreeInfo, schema) {
        ...
        if (propertyTables) {
            ...
            for (const propertyTable of propertyTables) {
                ...
                if (!metadataClass) {
                    throw new MetadataError_1.MetadataError(`The property table refers to class ${classId}, ` +
                ...
                const propertyTableModel = new BinaryPropertyTableModel_1.BinaryPropertyTableModel(binaryPropertyTable);
        ...
        if ((0, defined_1.defined)(subtree.tileMetadata)) {
            tileMetadataModel = propertyTableModels[subtree.tileMetadata];
            if (!tileMetadataModel) {
                throw new MetadataError_1.MetadataError(`The subtree tileMetadata refers to property ` +
        ...
        if (subtree.contentMetadata) {
            for (const contentMetadata of subtree.contentMetadata) {
                ...
                if (!contentMetadataModel) {
                    throw new MetadataError_1.MetadataError(`The subtree contentMetadata refers to property ` +
