...
class BasisEncoder {
     ...
     * @throws On error
     */
    static async ensureBasisEncoderImplInitialized() {
    ...
    static async create() {
        ...
        if (!BasisEncoder.BasisEncoderImpl) {
            throw new KtxError_1.KtxError("Could not initialize BasisEncoder");
        }
    ...
    get impl() {
        if (!this.implementation) {
            throw new KtxError_1.KtxError(`The BasisEncoder was already deleted. ` +
     ...
     * @returns The result
     */
    setSliceSourceImage(slice_index, src_image_js_val, width, height, src_image_is_png) {
        return this.impl.setSliceSourceImage(slice_index, src_image_js_val, width, height, src_image_is_png);
    }
    /**
     ...
     * @returns The result
     */
    setCheckForAlpha(check_for_alpha_flag) {
     ...
     * @returns The result
     */
    setForceAlpha(force_alpha_flag) {
     ...
     * @returns The result
     */
    setRenormalize(renormalize_flag) {
     ...
     * @returns The result
     */
    setMaxEndpointClusters(max_endpoint_clusters) {
     ...
     * @returns The result
     */
    setMaxSelectorClusters(max_selector_clusters) {
     ...
     * @returns The result
     */
    setSelectorRDOThresh(selector_rdo_thresh) {
     ...
     * @returns The result
     */
    setEndpointRDOThresh(endpoint_rdo_thresh) {
     ...
     * @returns The result
     */
    setCreateKTX2File(create_ktx2_file) {
     ...
     * @returns The result
     */
    setKTX2UASTCSupercompression(use_zstandard) {
     ...
     * @returns The result
     */
    setKTX2SRGBTransferFunc(srgb_transfer_func) {
     ...
     * @returns The result
     */
    setMipRenormalize(mip_renormalize_flag) {
     ...
     * @returns The result
     */
    setMipWrapping(mip_wrapping_flag) {
     ...
     * @returns The result
     */
    setMipSmallestDimension(mip_smallest_dimension) {
     ...
     * @returns The result
     */
    setPackUASTCFlags(pack_uastc_flags) {
     ...
     * @returns The result
     */
    setRDOUASTCQualityScalar(rdo_quality) {
     ...
     * @returns The result
     */
    setRDOUASTCMaxAllowedRMSIncreaseRatio(rdo_uastc_max_allowed_rms_increase_ratio) {
        return this.impl.setRDOUASTCMaxAllowedRMSIncreaseRatio(rdo_uastc_max_allowed_rms_increase_ratio);
    }
    /**
     ...
     * @returns The result
     */
    setRDOUASTCSkipBlockRMSThresh(rdo_uastc_skip_block_rms_thresh) {
        return this.impl.setRDOUASTCSkipBlockRMSThresh(rdo_uastc_skip_block_rms_thresh);
    }
    /**
     ...
     * @returns The result
     */
    setNoSelectorRDO(no_selector_rdo_flag) {
     ...
     * @returns The result
     */
    setNoEndpointRDO(no_endpoint_rdo_flag) {
