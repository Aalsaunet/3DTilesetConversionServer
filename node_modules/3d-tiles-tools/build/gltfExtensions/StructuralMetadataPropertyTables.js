...
exports.StructuralMetadataPropertyTables = void 0;
const MetadataError_1 = require("../metadata/MetadataError");
/**
 ...
 * @internal
 */
class StructuralMetadataPropertyTables {
    /**
     ...
     */
    static create(extStructuralMetadata, binaryPropertyTable) {
        ...
        for (const propertyName of propertyNames) {
            const propertyTableProperty = StructuralMetadataPropertyTables.createPropertyTableProperty(extStructuralMetadata, binaryPropertyTable, propertyName);
     ...
     * @throws MetadataError On errors (to be defined more precisely)
     */
    static createPropertyTableProperty(extStructuralMetadata, binaryPropertyTable, propertyId) {
        ...
        const arrayOffsetType = propertyTablePropertyJson.arrayOffsetType ?? "UINT32";
        // Obtain the `stringOffsets` buffer view data
        const stringOffsetsBufferViewIndex = propertyTablePropertyJson.stringOffsets;
        ...
        const stringOffsetType = propertyTablePropertyJson.stringOffsetType ?? "UINT32";
        // Create the glTF-Transform PropertyTableProperty object,
        // and fill it with the basic information from the raw JSON
        // property table property
        const propertyTableProperty = extStructuralMetadata.createPropertyTableProperty();
...
exports.StructuralMetadataPropertyTables = StructuralMetadataPropertyTables;
