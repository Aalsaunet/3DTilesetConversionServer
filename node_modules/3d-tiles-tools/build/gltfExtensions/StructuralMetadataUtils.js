...
exports.StructuralMetadataUtils = void 0;
const StringBuilder_1 = require("./StringBuilder");
const BinaryPropertyModels_1 = require("../metadata/binary/BinaryPropertyModels");
/**
 * Utilities related to the glTF `EXT_structural_metadata` extension.
 *
 * @internal
 */
class StructuralMetadataUtils {
    /**
     ...
     * @returns The string
     */
    static createStructuralMetadataInfoString(document) {
        const structuralMetadata = document
            .getRoot()
            .getExtension("EXT_structural_metadata");
        const sb = new StringBuilder_1.StringBuilder();
        if (structuralMetadata) {
            StructuralMetadataUtils.createStructuralMetadataString(sb, structuralMetadata);
        }
        const meshes = document.getRoot().listMeshes();
        StructuralMetadataUtils.createMeshesMetadataString(sb, meshes);
        return sb.toString();
    }
    static createStructuralMetadataString(sb, structuralMetadata) {
        ...
        for (let i = 0; i < propertyTables.length; i++) {
            ...
            sb.increaseIndent();
            StructuralMetadataUtils.createPropertyTableString(sb, propertyTable, schema);
            sb.decreaseIndent();
            sb.decreaseIndent();
        }
        sb.decreaseIndent();
    }
    static createPropertyTableString(sb, propertyTable, schema) {
        ...
        for (const propertyKey of propertyKeys) {
            ...
            if (propertyTableProperty) {
                ...
                StructuralMetadataUtils.createPropertyTablePropertyString(sb, propertyTableProperty);
                StructuralMetadataUtils.createPropertyTablePropertyValuesString(sb, propertyTableProperty, schema, className, propertyKey, rowCount);
                sb.decreaseIndent();
            }
            sb.decreaseIndent();
        }
    }
    static createPropertyTablePropertyValuesString(sb, propertyTableProperty, schema, className, propertyName, rowCount) {
        if (!schema) {
        ...
        if (!classProperty) {
            sb.addLine(`decoded values: (no property '${propertyName}' in class '${className}' in schema)`);
            return;
        }
        ...
        let stringOffsetsBufferViewData;
        if (stringOffsets) {
        ...
        const propertyModel = BinaryPropertyModels_1.BinaryPropertyModels.createPropertyModelInternal(propertyName, type, componentType, isArray, count, valuesBufferViewData, arrayOffsetsBufferViewData, arrayOffsetType, stringOffsetsBufferViewData, stringOffsetType, enumValueType);
    ...
    static createPropertyTablePropertyString(sb, propertyTableProperty) {
        sb.addLine("values: ", propertyTableProperty.getValues() ? "(present)" : "undefined");
        sb.addLine("arrayOffsets: ", propertyTableProperty.getArrayOffsets() ? "(present)" : "undefined");
        sb.addLine("stringOffsets: ", propertyTableProperty.getStringOffsets() ? "(present)" : "undefined");
        sb.addLine("arrayOffsetType: ", propertyTableProperty.getArrayOffsetType());
        sb.addLine("stringOffsetType: ", propertyTableProperty.getStringOffsetType());
    ...
    static createSchemaString(sb, schema) {
    ...
    static createClassString(sb, classObject) {
    ...
    static createClassPropertyString(sb, classProperty) {
    ...
    static createMeshesMetadataString(sb, meshes) {
        sb.addLine("Meshes");
    ...
    static createPrimitivesMetadataString(sb, primitives) {
        ...
        for (let p = 0; p < primitives.length; p++) {
            ...
            sb.increaseIndent();
            const meshPrimitiveStructuralMetadata = primitive.getExtension("EXT_structural_metadata");
            StructuralMetadataUtils.createMeshPrimitiveMetadataString(sb, meshPrimitiveStructuralMetadata);
            sb.decreaseIndent();
            sb.decreaseIndent();
        }
    }
    static createMeshPrimitiveMetadataString(sb, meshPrimitiveStructuralMetadata) {
        ...
        for (let a = 0; a < propertyAttributes.length; a++) {
            ...
            StructuralMetadataUtils.createPropertyAttributeString(sb, propertyAttribute);
            sb.decreaseIndent();
            sb.decreaseIndent();
        }
        sb.decreaseIndent();
    }
    static createPropertyTextureString(sb, propertyTexture) {
        ...
        for (const propertyKey of propertyKeys) {
            ...
            if (propertyTextureProperty) {
                sb.increaseIndent();
                StructuralMetadataUtils.createPropertyTexturePropertyString(sb, propertyTextureProperty);
                sb.decreaseIndent();
            }
            sb.decreaseIndent();
        }
    }
    static createPropertyTexturePropertyString(sb, propertyTextureProperty) {
    ...
    static createPropertyAttributeString(sb, propertyAttribute) {
        ...
        for (const propertyKey of propertyKeys) {
            ...
            if (propertyAttributeProperty) {
                sb.increaseIndent();
                StructuralMetadataUtils.createPropertyAttributePropertyString(sb, propertyAttributeProperty);
                sb.decreaseIndent();
            }
            sb.decreaseIndent();
        }
    }
    static createPropertyAttributePropertyString(sb, propertyAttributeProperty) {
...
exports.StructuralMetadataUtils = StructuralMetadataUtils;
