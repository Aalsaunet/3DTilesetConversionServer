...
class TileTableDataPnts {
    ...
    static createNormals(featureTable, binary, numElements) {
        ...
        if (featureTable.NORMAL_OCT16P) {
            ...
            const normals = Iterables_1.Iterables.map(octEncodedNormals, AttributeCompression_1.AttributeCompression.octDecode8);
            return normals;
        }
        return undefined;
    }
    ...
    static createNormalizedLinearColors(featureTable, binary, numElements) {
        ...
        if (featureTable.RGB565) {
            ...
            const colorsNormalizedLinearRGBA = Iterables_1.Iterables.map(colorsStandardRGB565, Colors_1.Colors.standardRGB565ToNormalizedLinearRGBA);
            return colorsNormalizedLinearRGBA;
        }
        return undefined;
    }
