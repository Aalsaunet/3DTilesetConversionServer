...
class Pipelines {
    ...
    static createPipeline(pipelineJson) {
        if (!pipelineJson.input) {
            throw new DeveloperError_1.DeveloperError("The pipeline JSON does not define an input");
        }
        if (!pipelineJson.output) {
            throw new DeveloperError_1.DeveloperError("The pipeline JSON does not define an output");
        }
