...
class Loggers {
     ...
     * @returns The Logger
     */
    static createDefaultLogger(toConsole, prettyPrint, logFilePath) {
        ...
        const transportTargetOptionsList = [];
        ...
        const logger = (0, pino_1.default)(loggerOptions, transport);
     ...
     * to the console
     */
    static initDefaultLogger(prettyPrint) {
        const toConsole = true;
        const logFilePath = undefined;
        const newDefaultLogger = Loggers.createDefaultLogger(toConsole, prettyPrint, logFilePath);
 ...
 */
Loggers.defaultLogger = Loggers.createDefaultLogger(true, true, undefined);
