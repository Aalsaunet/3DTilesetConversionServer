...
exports.BoundingVolumes = void 0;
/**
...
class BoundingVolumes {
     ...
     */
    static createUnitCubeBoundingBox() {
        return {
            min: [0, 0, 0],
            max: [1, 1, 1],
        };
     ...
     */
    static createUnitCubeBoundingVolumeBox() {
        return BoundingVolumes.createBoundingVolumeBoxFromBoundingBox(BoundingVolumes.createUnitCubeBoundingBox());
    }
    /**
     ...
     */
    static createBoundingVolumeBoxFromBoundingBox(boundingBox) {
        return BoundingVolumes.createBoundingVolumeBox(boundingBox.min[0], boundingBox.min[1], boundingBox.min[2], boundingBox.max[0], boundingBox.max[1], boundingBox.max[2]);
    }
    /**
     ...
     * @returns The corners
     */
    static computeBoundingBoxCorners(boundingBox) {
        const min = boundingBox.min;
        const max = boundingBox.max;
        const c0 = [min[0], min[1], min[2]];
        const c1 = [max[0], min[1], min[2]];
        const c2 = [min[0], max[1], min[2]];
        const c3 = [max[0], max[1], min[2]];
        const c4 = [min[0], min[1], max[2]];
        const c5 = [max[0], min[1], max[2]];
        const c6 = [min[0], max[1], max[2]];
        const c7 = [max[0], max[1], max[2]];
     ...
     * @returns The `boundingVolume.box`
     */
    static createBoundingVolumeBox(minX, minY, minZ, maxX, maxY, maxZ) {
        // The size of the box
        const dx = maxX - minX;
        const dy = maxY - minY;
        const dz = maxZ - minZ;
     ...
     * @returns The `boundingVolume.box`
     */
    static createBoundingVolumeBoxFromGltfBoundingBox(boundingBox) {
        // Take into account the y-up-to-z-up transform:
        return BoundingVolumes.createBoundingVolumeBox(boundingBox.min[0], -boundingBox.min[2], boundingBox.min[1], boundingBox.max[0], -boundingBox.max[2], boundingBox.max[1]);
    }
    /**
     ...
     * @returns The bounding box
     */
    static createBoundingBoxForBoundingVolumeBox(boundingVolumeBox) {
     ...
     */
    static translateBoundingBox(boundingBox, translation) {
        return {
     ...
     * @returns The union
     */
    static computeBoundingBoxUnion(bb0, bb1) {
        return {
...
exports.BoundingVolumes = BoundingVolumes;
