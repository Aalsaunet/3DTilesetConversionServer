...
exports.TilesetProcessorContexts = void 0;
 ...
 * @internal
 */
class TilesetProcessorContexts {
    /**
     ...
     */
    static async create(tilesetSourceName, tilesetTargetName, overwrite) {
        let tilesetSource;
        let tilesetTarget;
        try {
            ...
            const tilesetSourceJsonFileName = TilesetProcessorContexts.determineTilesetJsonFileName(tilesetSourceName);
            const tilesetTargetJsonFileName = TilesetProcessorContexts.determineTilesetJsonFileName(tilesetTargetName);
     ...
     */
    static determineTilesetJsonFileName(tilesetDataName) {
        if (tilesetDataName.toLowerCase().endsWith(".json")) {
            return path_1.default.basename(tilesetDataName);
        }
        return "tileset.json";
    }
}
exports.TilesetProcessorContexts = TilesetProcessorContexts;
