...
const GltfTransformPointClouds_1 = require("../contentProcessing/pointClouds/GltfTransformPointClouds");
...
const DefaultPropertyModel_1 = require("../metadata/DefaultPropertyModel");
        ...
        for (const propertyName of dracoPropertyNames) {
            ...
            if (propertyValue) {
                if (TileTableData_1.TileTableData.isBatchTableBinaryBodyReference(propertyValue)) {
                    ...
                    if (attributeValues) {
                        const propertyModel = new DefaultPropertyModel_1.DefaultPropertyModel([
                            ...attributeValues,
                        ]);
