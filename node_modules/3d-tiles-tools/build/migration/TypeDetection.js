...
exports.TypeDetection = void 0;
const NumberTypeDescriptions_1 = require("./NumberTypeDescriptions");
/**
...
class TypeDetection {
     ...
     */
    static containsOnlyArrays(value) {
     ...
     */
    static computeCommonArrayLegth(value) {
        let commonLength = undefined;
        for (const element of value) {
     ...
     */
    static computeCommonComponentType(array) {
        const commonComponentType = NumberTypeDescriptions_1.NumberTypeDescriptions.computeComponentType(array);
     ...
     */
    static computeCommonType(array) {
    ...
    static computeType(value) {
        ...
        if (Array.isArray(value)) {
            const commonElementType = TypeDetection.computeCommonArrayElementType(value);
     ...
     */
    static computeCommonArrayElementType(array) {
        let commonElementType = undefined;
        for (let i = 0; i < array.length; i++) {
            const element = array[i];
...
exports.TypeDetection = TypeDetection;
