...
class BatchTableClassProperties {
    ...
    static createClassProperty(batchTablePropertyName, batchTablePropertyValue) {
        ...
        let array = false;
        let count = undefined;
        if (TileTableData_1.TileTableData.isBatchTableBinaryBodyReference(batchTablePropertyValue)) {
            type = TileTableData_1.TileTableData.convertLegacyTypeToType(batchTablePropertyValue.type);
            componentType = TileTableData_1.TileTableData.convertLegacyComponentTypeToComponentType(batchTablePropertyValue.componentType);
        }
            ...
            throw new TileFormatError_1.TileFormatError(`Batch table JSON property ${batchTablePropertyName} was ` +
