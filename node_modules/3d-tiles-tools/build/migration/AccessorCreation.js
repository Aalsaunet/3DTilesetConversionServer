...
class AccessorCreation {
    ...
    static createAccessorFromValues(document, classProperty, accessorValues) {
        ...
        if (!classProperty.componentType) {
            throw new TileFormatError_1.TileFormatError(`Cannot create accessor for property with ` +
    ...
    static getAccessorType(classPropertyType) {
        ...
        throw new TileFormatError_1.TileFormatError("Invalid class property type: " + classPropertyType);
    }
    /**
    ...
    static createAccessorValues(classProperty, propertyModel, numRows) {
        if (classProperty.array === true ||
            ...
            const iterable = PropertyModels_1.PropertyModels.createNumericArrayIterable(propertyModel, numRows);
            return Iterables_1.Iterables.flatten(iterable);
        }
        const iterable = PropertyModels_1.PropertyModels.createNumericScalarIterable(propertyModel, numRows);
        return iterable;
    }
    /**
    ...
    static createAccessorArray(componentType, accessorValues) {
        ...
        throw new TileFormatError_1.TileFormatError("Cannot create accessor with component type " + componentType);
    }
}
