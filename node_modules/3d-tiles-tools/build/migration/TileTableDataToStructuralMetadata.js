...
const StructuralMetadataPropertyTables_1 = require("../gltfExtensions/StructuralMetadataPropertyTables");
...
const PropertyTableModels_1 = require("../metadata/PropertyTableModels");
const PropertyModels_1 = require("../metadata/PropertyModels");
const BinaryPropertyTableModel_1 = require("../metadata/binary/BinaryPropertyTableModel");
const BinaryPropertyTableBuilder_1 = require("../metadata/binary/BinaryPropertyTableBuilder");
...
class TileTableDataToStructuralMetadata {
    ...
    static assignPerPointProperties(document, primitive, batchTable, batchTableBinary, externalProperties, numRows) {
        ...
        const extStructuralMetadata = document.createExtension(EXTStructuralMetadata_1.EXTStructuralMetadata);
        ...
        if (TileFormatsMigration_1.TileFormatsMigration.DEBUG_LOG_FILE_CONTENT &&
            logger.isLevelEnabled("trace")) {
            const s = PropertyTableModels_1.PropertyTableModels.createString(batchTablePropertyTableModel, 10);
    ...
    static convertBatchTableToPropertyTable(document, batchTable, batchTableBinary, numRows) {
        ...
        const b = BinaryPropertyTableBuilder_1.BinaryPropertyTableBuilder.create(metadataSchema, className, "Property Table");
        const properties = metadataClass.properties || {};
        const propertyNames = Object.keys(properties);
        for (const propertyName of propertyNames) {
            const propertyModel = batchTablePropertyTableModel.getPropertyModel(propertyName);
            ...
            const values = PropertyModels_1.PropertyModels.createIterable(propertyModel, numRows);
        ...
        if (TileFormatsMigration_1.TileFormatsMigration.DEBUG_LOG_FILE_CONTENT &&
            logger.isLevelEnabled("trace")) {
            const m = new BinaryPropertyTableModel_1.BinaryPropertyTableModel(binaryPropertyTable);
            const s = PropertyTableModels_1.PropertyTableModels.createString(m);
